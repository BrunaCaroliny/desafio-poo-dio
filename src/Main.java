...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Conteúdos Inscritos de Bruna:" + devBruna.getConteudosInscritos());
        devBruna.progredir();
        devBruna.progredir();
        System.out.println("-");
        System.out.println("Conteúdos Inscritos de Bruna:" + devBruna.getConteudosInscritos());
        System.out.println("Conteúdos Concluídos de Bruna:" + devBruna.getConteudosConcluidos());
